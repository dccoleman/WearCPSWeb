...
ggplot(filterNotificationGradeLevels, aes(x=GradeLevel, y=Correct, fill=GradeLevel, width=.5)) +  stat_summary(fun.y="mean", geom ="point") + ggtitle("Grade Levels Vs Correctness") + labs(x="Grade Level", y ="Correctness")
