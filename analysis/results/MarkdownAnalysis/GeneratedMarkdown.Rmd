...
scoreData = subset(filterPrimaryTaskScoreTimes, ParticipantID=='A1HWTTN3JEUNZY')

notifData = subset(filterNotificationTimeAndCorrectness, participantID=='A1HWTTN3JEUNZY')
