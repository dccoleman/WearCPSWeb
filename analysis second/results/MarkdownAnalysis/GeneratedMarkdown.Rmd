...
ggplot(filterEducationVsPerformance, aes(x=Education.Level, y=FinalScore, fill=Education.Level)) + stat_summary(fun.y="mean", geom="bar") + ggtitle("Education Level Vs Scores") +
  labs(x="Education Level",y="Scores") 

ggplot(filterEducationVsPerformance, aes(x=Education.Level, y=NotificationCorrect, fill=Education.Level)) + stat_summary(fun.y="mean", geom="bar") + ggtitle("Education Level Vs Notifications Correct") + labs(x="Education Level",y="Number Correct") 
```
